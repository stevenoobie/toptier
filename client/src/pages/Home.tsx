        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-[#1d2d3d] dark:text-foreground mb-6 leading-[1.1]">
              <span className="text-[#1d2d3d] dark:text-foreground">elevate your</span> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">game</span>
            </h1>
